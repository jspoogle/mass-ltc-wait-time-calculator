...
with main_col:
    ...
    with st.container(border=True):
        ...
        st.markdown("""
        <div style="text-align: center; font-size: 1.35em; font-weight: 600; margin-bottom: 1px;">
...
sub_serials = [45676, 45690, 45698, 45707, 45709, 45712, 45712, 45712, 45712, 45716,
               ...
               45834, 45846, 45862, 45864, 45871, 45897, 45901]
fp_serials = [45889, 45908, 45915, 45919, 45923, 45924, 45926, 45929, 45930, 45931,
              ...
              46066, 46080, 46091, 46093, 46099, 46125, 46129]
